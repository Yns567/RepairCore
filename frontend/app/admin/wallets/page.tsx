                ...
                <tr key={user.id}>
                  ...
                  <td className="px-4 py-3">
                    <form action={addWalletCredit} className="flex items-center gap-2">
                      ...
                      <input name="amount" type="number" min="0.01" step="0.01" required placeholder="Amount" className="w-24 rounded border border-gray-300 px-2 py-1.5" />
                      <select name="type" defaultValue="CREDIT" className="rounded border border-gray-300 px-2 py-1.5">
                        <option value="CREDIT">Credit</option>
                        <option value="REFUND">Refund</option>
                        <option value="ADJUSTMENT">Adjustment</option>
                      </select>
                      <input name="description" required minLength={3} maxLength={200} placeholder="Reason / payment reference" className="w-56 rounded border border-gray-300 px-2 py-1.5" />
